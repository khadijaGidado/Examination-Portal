...
$Exam_id=$data['Auto_increment'];
    ...
    $work="INSERT INTO theoryquestion(Examid, questio_no, question) VALUES ($Exam_id, $i,'".$_POST['q'.$i]."')";
...
<form method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control col-lg-6" id="formGroupExampleInput" placeholder="Theory,obj..." name="type" value="Theory" readonly>
  </div>
...
<!-- 
  <div class="form-group">
    <label for="formGroupExampleInput">Course code:</label>
    <input type="text" class="form-control col-lg-6" id="formGroupExampleInput" placeholder="username" name="username">
  </div> -->
